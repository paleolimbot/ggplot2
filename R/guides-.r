...
# building guides - called in ggplot_gtable.ggplot_built() (plot-build.r)
#
...
build_guides <- function(scales, layers, default_mapping, position, theme, guides, labels) {
  ...
  gdefs <- guides_train(scales = scales$non_position_scales(), theme = theme, guides = guides, labels = labels)
